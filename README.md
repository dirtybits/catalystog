...
Catalyst is an experimental digital currency and P2P payment system that allows users to send and receive payments to and from anyone in the world. The coin also contains many of the anonymity features utilized by its fellow Cryptonote derivatives. These properties make Catalyst a fine choice for a wide variety of transactional purposes.
