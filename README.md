...
Catalyst is an experimental digital currency and P2P payment system that allows users to quickly send and receive payments to and from anyone in the world. The coin also contains many of the privacy & security features utilized by its fellow Cryptonote derivatives. These properties make Catalyst applicable to a wide variety of transactions.
