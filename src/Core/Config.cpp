...
const static UUID CATALYST_NETWORK{{0x11, 0x10, 0x01, 0x11, 0x11, 0x00, 0x01, 0x01, 0x10, 0x11, 0x00, 0x12, 0x10, 0x11,
    0x01, 0x10}};  // Bender's nightmare ( this is Bytecoin's network identifier)
    Here is our potential network identifier
    0xd7, 0x70, 0x17, 0x55, 0x1a, 0x6f, 0x4e, 0x4f, 0x54, 0x45, 0x01, 0x12, 0xc1, 0xd1, 0xb1, 0xf1 
*/
