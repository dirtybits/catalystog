...
static const float DB_COMMIT_PERIOD_CATALYSTD    = 310;  // 5 minutes sounds good compromise
...
public:
	...
	bool on_wallet_sync3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::SyncBlocks::Request &&, api::catalystd::SyncBlocks::Response &);
	bool on_sync_mempool3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::SyncMemPool::Request &&, api::catalystd::SyncMemPool::Response &);
	bool on_get_raw_transaction3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetRawTransaction::Request &&, api::catalystd::GetRawTransaction::Response &);

	api::catalystd::GetStatus::Response create_status_response3() const;
	// json_rpc_node
	bool on_get_status3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetStatus::Request &&, api::catalystd::GetStatus::Response &);
	bool on_get_random_outputs3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetRandomOutputs::Request &&, api::catalystd::GetRandomOutputs::Response &);
	bool handle_send_transaction3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::SendTransaction::Request &&, api::catalystd::SendTransaction::Response &);
	bool handle_check_send_proof3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::CheckSendProof::Request &&, api::catalystd::CheckSendProof::Response &);
	bool on_getblocktemplate(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetBlockTemplate::Request &&r, api::catalystd::GetBlockTemplate::Response &);
	void getblocktemplate(
	    const api::catalystd::GetBlockTemplate::Request &, api::catalystd::GetBlockTemplate::Response &);
	bool on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetCurrencyId::Request &&, api::catalystd::GetCurrencyId::Response &);
	bool on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::SubmitBlock::Request &&, api::catalystd::SubmitBlock::Response &);
	bool on_submitblock_legacy(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::SubmitBlockLegacy::Request &&, api::catalystd::SubmitBlockLegacy::Response &);
	bool on_get_last_block_header(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetLastBlockHeaderLegacy::Request &&, api::catalystd::GetLastBlockHeaderLegacy::Response &);
	bool on_get_block_header_by_hash(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetBlockHeaderByHashLegacy::Request &&, api::catalystd::GetBlockHeaderByHashLegacy::Response &);
	bool on_get_block_header_by_height(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::catalystd::GetBlockHeaderByHeightLegacy::Request &&,
	    api::catalystd::GetBlockHeaderByHeightLegacy::Response &);
...
protected:
	...
	struct LongPollClient {
		...
		api::catalystd::GetStatus::Request original_get_status;
	};
	...
	class P2PClientCatalyst : public P2PClientBasic {
		Node *const m_node;
...
#endif
	public:
		explicit P2PClientCatalyst(Node *node, bool incoming, D_handler d_handler)
	...
	std::unique_ptr<P2PClient> client_factory(bool incoming, P2PClient::D_handler d_handler) {
		return std::make_unique<P2PClientCatalyst>(this, incoming, d_handler);
	}
	...
	class DownloaderV11 {  // torrent-style sync&download from legacy v1 clients
		...
		std::map<P2PClientCatalyst *, size_t> m_good_clients;  // -> # of downloading blocks
		size_t total_downloading_blocks = 0;
		std::list<P2PClientCatalyst *> m_who_downloaded_block;
		P2PClientCatalyst *m_chain_client = nullptr;
		...
		struct DownloadCell {
			...
			P2PClientCatalyst *downloading_client = nullptr;
	...
	public:
		...
		void on_connect(P2PClientCatalyst *);
		void on_disconnect(P2PClientCatalyst *);
		const std::map<P2PClientCatalyst *, size_t> &get_good_clients() const { return m_good_clients; }
		void on_msg_notify_request_chain(P2PClientCatalyst *, const NOTIFY_RESPONSE_CHAIN_ENTRY::request &);
		void on_msg_notify_request_objects(P2PClientCatalyst *, const NOTIFY_RESPONSE_GET_OBJECTS::request &);
	...
	/*	class DownloaderV1 {  // sync&download from legacy v1 clients
	        ...
	        std::map<P2PClientCatalyst *, size_t> m_good_clients;
	        P2PClientCatalyst *m_sync_client = nullptr;
	...
	void sync_transactions(P2PClientCatalyst *);
